...
namespace ChatBot.Commands
{
    internal class HelpCommand : Command
    {
        ...
        {
            return
            "При использовании бота в беседе добавлейте перед командой одно из следующих обращений:\n" +
            "ura, ура, *ura_da_davai, @ura_da_davai, @ura_da_davai_bot\n" +
            "\n" +
            "\n" +
            ...
            "\n" +
            "\n" +
            "• микс/mix <фраза> <число> - повтор фразы с перемешиванием слов\n" +
            "<фраза> - фраза, которую надо повторить\n" +
            "<число> - количество повторов фразы (от 1 до 1000)";
        }
    }
}
